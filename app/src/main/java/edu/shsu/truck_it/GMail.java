...
public class GMail {
    final String emailPort = "587";// gmail's smtp port 465 or 587
    ...
    public MimeMessage createEmailMessage() throws AddressException, MessagingException, UnsupportedEncodingException {
        ...
        //changed from String toEmail to Object toEmail
